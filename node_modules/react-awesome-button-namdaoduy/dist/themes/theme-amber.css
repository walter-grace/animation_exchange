.aws-btn {
  ...
  --button-primary-color: #325c99;
  --button-primary-color-dark: #1f395f;
  --button-primary-color-light: #d8e3f2;
  --button-primary-color-hover: #2c5086;
  --button-primary-color-active: #254573;
  --button-primary-border: none;
  --button-secondary-color: #afafaf;
  --button-secondary-color-dark: #898989;
  --button-secondary-color-light: white;
  --button-secondary-color-hover: #a2a2a2;
  --button-secondary-color-active: #969696;
  --button-secondary-border: none;
  --button-anchor-color: #afafaf;
  --button-anchor-color-dark: #898989;
  --button-anchor-color-light: white;
  --button-anchor-color-hover: #a2a2a2;
  --button-anchor-color-active: #969696;
  --button-anchor-border: none;
  --button-disabled-color: #9E9E9E;
  --button-disabled-color-dark: #325c99;
  --button-disabled-color-light: #325c99;
  --button-disabled-color-hover: #919191;
  --button-disabled-color-active: #858585;
  --button-disabled-border: none;
  --button-placeholder-color: #BABABA;
  --button-placeholder-color-dark: #325c99;
  --button-placeholder-color-light: #325c99;
  --button-placeholder-color-hover: #adadad;
  --button-placeholder-color-active: #a1a1a1;
...
.aws-btn {
  ...
  .aws-btn .aws-btn__content {
    ...
    .aws-btn .aws-btn__content > span:nth-child(1) {
      display: block; }
      .aws-btn .aws-btn__content > span:nth-child(1) > svg, .aws-btn .aws-btn__content > span:nth-child(1) > img > span {
        vertical-align: middle; }
  .aws-btn:before {
    content: " ";
...
.aws-btn--progress .aws-btn__progress {
  ...
  z-index: 3;
  overflow: hidden;
  -webkit-transition: border 0.175s ease-out, background 0.175s ease-out, color 0.175s ease-out, -webkit-transform 0.175s ease-out;
  transition: border 0.175s ease-out, background 0.175s ease-out, color 0.175s ease-out, -webkit-transform 0.175s ease-out;
  transition: border 0.175s ease-out, transform 0.175s ease-out, background 0.175s ease-out, color 0.175s ease-out;
  transition: border 0.175s ease-out, transform 0.175s ease-out, background 0.175s ease-out, color 0.175s ease-out, -webkit-transform 0.175s ease-out; }
  .aws-btn--progress .aws-btn__progress > span {
    -webkit-transition: opacity 0.0875s ease-out 0.13125s;
    transition: opacity 0.0875s ease-out 0.13125s; }
  .aws-btn--progress .aws-btn__progress:before, .aws-btn--progress .aws-btn__progress:after {
    ...
    opacity: 0;
    -webkit-transition: opacity 0.13125s ease-out 0.05s, -webkit-transform 0.175s ease-out 0.05s;
    transition: opacity 0.13125s ease-out 0.05s, -webkit-transform 0.175s ease-out 0.05s;
    transition: transform 0.175s ease-out 0.05s, opacity 0.13125s ease-out 0.05s;
    transition: transform 0.175s ease-out 0.05s, opacity 0.13125s ease-out 0.05s, -webkit-transform 0.175s ease-out 0.05s; }
