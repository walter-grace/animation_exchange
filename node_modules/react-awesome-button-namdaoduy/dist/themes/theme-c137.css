...
.aws-btn--progress .aws-btn__progress {
  ...
  .aws-btn--progress .aws-btn__progress > span {
    -webkit-transition: opacity 0.0925s ease-out 0.13875s;
    transition: opacity 0.0925s ease-out 0.13875s; }
  .aws-btn--progress .aws-btn__progress:before, .aws-btn--progress .aws-btn__progress:after {
    ...
    opacity: 0;
    -webkit-transition: opacity 0.13875s ease-out 0.05s, -webkit-transform 0.185s ease-out 0.05s;
    transition: opacity 0.13875s ease-out 0.05s, -webkit-transform 0.185s ease-out 0.05s;
    transition: transform 0.185s ease-out 0.05s, opacity 0.13875s ease-out 0.05s;
    transition: transform 0.185s ease-out 0.05s, opacity 0.13875s ease-out 0.05s, -webkit-transform 0.185s ease-out 0.05s; }
